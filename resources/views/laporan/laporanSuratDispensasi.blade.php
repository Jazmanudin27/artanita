...
@section('titlepage', 'Laporan Surat Dispensasi')
@section('content')
    <div class="container-fluid p-0">
        <h1 class="h3 mb-3">Laporan Surat Dispensasi</h1>
        <div class="row">
            <div class="col-12 col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('cetakLaporanSuratDispensasi') }}" method="POST" autocomplete="off"
                            target="_blank">
                            @csrf
                            <div class="mb-3">
                                <div class="row">
