...
@section('titlepage', 'Laporan Absensi Siswa')
@section('content')
    <div class="container-fluid p-0">
        <h1 class="h3 mb-3">Laporan Absensi Siswa</h1>
        <div class="row">
            <div class="col-12 col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('cetakLaporanAbsensiSiswa') }}" method="POST" autocomplete="off"
                            target="_blank">
                            @csrf
