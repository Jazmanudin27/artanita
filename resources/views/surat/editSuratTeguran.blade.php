    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-12 col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('updateSuratTeguran') }}" method="POST" autocomplete="off">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label">Tanggal</label>
                                <input type="hidden" value="{{ $surat_teguran->id }}" name="id" class="form-control"
                                    placeholder="ID">
                                <input type="text" name="tanggal" value="{{ $surat_teguran->tanggal }}"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" name="kode_siswa" id="kode_siswa">
                                    ...
                                    @foreach ($siswa as $k)
                                        <option {{ $surat_teguran->kode_siswa == $k->kode_siswa ? 'selected' : '' }}
                            ...
                            <div class="mb-3">
                                ...
                                <textarea required class="form-control" rows="7" id="deskripsi" name="deskripsi">{{ $surat_teguran->deskripsi }}</textarea>
                            </div>
