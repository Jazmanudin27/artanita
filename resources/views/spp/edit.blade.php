...
@section('titlepage', 'Edit Peminjaman Buku')
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('updatePeminjaman') }}" method="POST" autocomplete="off">
                            @csrf
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select2" name="kode_siswa" id="kode_siswa" required>
                                            ...
                                            @foreach ($siswa as $s)
                                                <option {{ $peminjaman->kode_siswa == $s->kode_siswa ? 'selected' : '' }}
                                                    value="{{ $s->kode_siswa }}">{{ $s->nama_siswa }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xl-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{ $peminjaman->tanggal }}" name="tanggal"
                                ...
                                <div class="col-xl-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{ $peminjaman->tgl_kembali }}" name="tgl_kembali"
                                ...
                                <div class="col-xl-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" id="kode_buku" value="{{ $peminjaman->kode_buku }}"
                                            name="kode_buku" class="form-control" placeholder="Kode Buku" required>
                                        <input type="hidden" id="id" value="{{ $peminjaman->id }}" name="id"
                                            class="form-control" placeholder="Kode Buku" required>
                                        <input type="text" id="judul" value="{{ $peminjaman->judul }}"
                                ...
                                <div class="col-xl-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="pengarang" value="{{ $peminjaman->pengarang }}" readonly
                                ...
                                <div class="col-xl-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="penerbit" value="{{ $peminjaman->penerbit }}" readonly
                                ...
                                <div class="col-xl-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="tahun_terbit" value="{{ $peminjaman->tahun_terbit }}"
                                            readonly class="form-control" placeholder="Tahun Terbit">
                                    </div>
                                </div>
                                <div class="col-xl-2">
                                    <div class="mb-3">
                                        <label class="form-label">Stok</label>
                                        <input type="number" id="stok" value="{{ $peminjaman->sisa_stok }}" readonly
