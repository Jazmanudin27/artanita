@if(count($guru) > 0)
    <div class="rekap-guru-container">
        @foreach ($guru as $g)
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between mb-2 pb-2 border-bottom">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div>
                                <div class="font-weight-bold text-dark" style="font-size: 0.9rem;">{{ $g->nama_guru }}</div>
                                <div class="text-muted" style="font-size: 0.72rem;">NIP/NUPTK: {{ $g->nip_nuptk ?: '-' }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row text-center g-2 mt-1">
                        <div class="col-3">
                            <div class="p-2" style="background: #dcfce7; border-radius: 10px;">
                                <div class="font-weight-bold text-success" style="font-size: 1.1rem; line-height: 1;">{{ $g->total_hadir }}</div>
                        ...
                        <div class="col-3">
                            <div class="p-2" style="background: #fef3c7; border-radius: 10px;">
                                <div class="font-weight-bold" style="font-size: 1.1rem; line-height: 1; color: #d97706 !important;">{{ $g->total_sakit }}</div>
                        ...
                        <div class="col-3">
                            <div class="p-2" style="background: #e0f2fe; border-radius: 10px;">
                                <div class="font-weight-bold" style="font-size: 1.1rem; line-height: 1; color: #0284c7 !important;">{{ $g->total_izin }}</div>
                                <div class="font-weight-bold" style="font-size: 0.75rem; margin-top: 2px; color: #0284c7 !important;">I</div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="p-2" style="background: #f3e8ff; border-radius: 10px;">
                                <div class="font-weight-bold" style="font-size: 1.1rem; line-height: 1; color: #7c3aed !important;">{{ $g->total_cuti }}</div>
                                <div class="font-weight-bold" style="font-size: 0.75rem; margin-top: 2px; color: #7c3aed !important;">C</div>
                            </div>
                        </div>
                    </div>
                </div>
...
@else
    <div class="card border-0 shadow-sm text-center p-4" style="border-radius: 16px; background: #ffffff;">
        ...
        <div class="font-weight-bold text-dark mt-2" style="font-size: 0.95rem;">Tidak ada data rekap presensi guru</div>
        <div class="text-muted" style="font-size: 0.8rem;">Pilih bulan atau tahun lain.</div>
    </div>
@endif
