@if(count($siswa) > 0)
    <div class="rekap-siswa-container">
        @foreach ($siswa as $s)
...
@else
    <div class="card border-0 shadow-sm text-center p-4" style="border-radius: 16px; background: #ffffff;">
        ...
        <div class="font-weight-bold text-dark mt-2" style="font-size: 0.95rem;">Tidak ada rekap absensi</div>
        <div class="text-muted" style="font-size: 0.8rem;">Pilih bulan, tahun, atau kelas lain.</div>
    </div>
@endif
